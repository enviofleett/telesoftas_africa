...
export default function Hero({
    ...
    // Force /#contact if the link is specifically /contact to avoid 404
    const resolvedLink = buttonLink === "/contact" ? "/#contact" : (buttonLink || "/#contact");
    return (
        <section className={styles.hero}>
            ...
            <div className={styles.container}>
                <div className={styles.whiteBox}>
                    ...
                    <Link href={resolvedLink} className={styles.convButton}>
                        {buttonText}
